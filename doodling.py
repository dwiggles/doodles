...
class Application(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.pack()
        self.createWidgets()
        self.recursive_construction(N=2, size=1, rotate=pi, initial_size_scalar=50)
    ...
    def recursive_construction(self, N, size, rotate, initial_size_scalar):
    ...
    def response(self, event):
        ...
        self.recursive_construction(N_tiles, size, rotate, initial_size_scalar)
